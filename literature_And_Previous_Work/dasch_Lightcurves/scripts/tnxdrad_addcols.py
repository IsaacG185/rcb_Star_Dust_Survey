...
if len(sys.argv) < 2:
    print(
        "Open XML VO table with TNX match info, add drad and offset columns and save in fits format"
    )
    print("Usage: tnxdrad_addcols.py fin")
    print("  fin: input XML VO table filename")
    sys.exit()
