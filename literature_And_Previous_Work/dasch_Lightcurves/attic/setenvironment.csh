...
if (0) then
   ...
   rm  mosaic 
   ln -s  /n/dasch14 mosaic
   rm  magnitudes 
   ln -s  /n/dasch13/mysql/photfiles magnitudes
   rm  magnitudes1 
   ln -s  /n/dasch13/mysql/photfiles1 magnitudes1
   rm  magnitudes2 
   ln -s  /n/dasch13/mysql/photfiles2 magnitudes2
   rm  magnitudes3 
   ln -s /n/dasch13/mysql/photfiles3 magnitudes3
   rm  magnitudes4 
   ln -s /n/dasch13/mysql/photfiles3 magnitudes4
endif
echo "2"
if (0) then
   cd /dasch
...
if (0) then
   cd /dasch
   rm  magnitudes
   ln -s  /dasch11/mysql/photfiles magnitudes
   rm  magnitudes1 
   ln -s  /dasch11/mysql/photfiles1 magnitudes1
   rm  magnitudes2 
   ln -s  /dasch11/mysql/photfiles2 magnitudes2
   rm  magnitudes3 
    ln -s /dasch11/mysql/photfiles3 magnitudes3
    ls -l /dasch/mag* 
endif
echo "7"
...
echo "dasch11"
ls  /dasch/raid024/ExposureData/
echo "dasch12"
ls  /dasch/raid025/ExposureData/Mosaics/
echo "raid013"
ls  /dasch/raid026/ExposureData/Mosaics/
echo "dasch14"
ls /n/dasch14/ExposureData
echo "dasch15"
ls /n/dasch15/ExposureData/Mosaics
echo "dasch16"
ls /n/dasch16/
