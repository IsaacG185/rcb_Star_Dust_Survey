...
echo "cd /dasch/mosaic4/ExposureData/Logs/$hDate/"
cd /dasch/mosaic4/ExposureData/Logs/$hDate/
echo "mkdir -p /dasch/raid021/junk/Logs/${uDate}/Logs"
mkdir -p /dasch/raid021/junk/Logs/${uDate}/Logs
cp * /dasch/raid021/junk/Logs/${uDate}/Logs
cd /dasch/raid021/junk/Logs/${uDate}/Logs
echo "cp Linux.bat ../process${uDate}.tmp2"
cp Linux.bat ../process${uDate}.tmp2
cd ..
dos2unix -f process${uDate}.tmp2
echo "exit\ndate\ncd /dasch/mosaic4/ExposureData\ncat /proc/diskstats\ncp -r * /dasch/raid0${raidArray}/ExposureData/\ncat /proc/diskstats\ndate\n" > process${uDate}.tmp1
...
chmod -R g+w /dasch/raid021/junk/Logs/
cd ~
