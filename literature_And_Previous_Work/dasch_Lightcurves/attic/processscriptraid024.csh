...
echo "mkdir -p /dasch/raid024/junk/Logs/${uDate}/Logs"
mkdir -p /dasch/raid024/junk/Logs/${uDate}/Logs
cp * /dasch/raid024/junk/Logs/${uDate}/Logs
cd /dasch/raid024/junk/Logs/${uDate}/Logs
...
chmod -R g+w /dasch/raid024/junk/Logs/
cd ~
