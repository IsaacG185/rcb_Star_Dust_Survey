...
echo "cd /dasch/raid014/ExposureData/Logs/$hDate/"
cd /dasch/raid014/ExposureData/Logs/$hDate/
echo "mkdir -p /dasch/raid020/junk/Logs/${uDate}/Logs"
mkdir -p /dasch/raid020/junk/Logs/${uDate}/Logs
cp * /dasch/raid020/junk/Logs/${uDate}/Logs
cd /dasch/raid020/junk/Logs/${uDate}/Logs
echo "cp Linux.bat ../process${uDate}.tmp2"
cp Linux.bat ../process${uDate}.tmp2
cd ..
dos2unix -f process${uDate}.tmp2
echo "exit\ndate\ncd /dasch/raid014/ExposureData\ncat /proc/diskstats\ncp -r * /dasch/raid0${raidArray}/ExposureData/\ncat /proc/diskstats\ndate\n" > process${uDate}.tmp1
...
chmod -R g+w /dasch/raid020/junk/Logs/
cd ~
